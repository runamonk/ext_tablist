...
- Middle-click rows to queue tabs for closing; queued rows are dimmed and struck through. Click or middle-click a queued row to undo. Browser tabs close when the popup hides or closes.
